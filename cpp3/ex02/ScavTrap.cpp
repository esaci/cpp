...
void		ScavTrap::guardGate( void ){std::cout << "ScavTrap " << Name << " has entered in defensive mode ?!" << std::endl;}
void	ScavTrap::attack(std::string const &target){std::cout << "ScavTrap " << Name << " attacks " << target << " ?!" << std::endl;}
